...
func _ready():
	speed+=GLOBAL.nave3.motor
	cantidadEscudos = GLOBAL.nave3.escudo
	print("Velocidad del jugador: ", speed)
	print("Velocidad disparo del jugador: ", GLOBAL.nave3.velocidadDisparo)
	print("Escudos ORIGINALES: ", GLOBAL.nave3.escudo)
...
func get_input():
	...
	position.x = clamp(position.x,291,732)#original 256, 768
...
func _shoot():
	if Input.is_action_pressed("ui_accept") and can_shoot:
		shoot_ctrl()
		can_shoot = false
		$RetardoDisparo.wait_time=GLOBAL.nave3.velocidadDisparo
...
func shoot_ctrl():
	...
	var shoot3 = Shoot.instance()
	var shoot4 = Shoot.instance()
	...
	shoot3.global_position = $ShootSpawn3.global_position
	get_tree().call_group("level", "add_child", shoot3)
	shoot4.global_position = $ShootSpawn4.global_position
	get_tree().call_group("level", "add_child", shoot4)
